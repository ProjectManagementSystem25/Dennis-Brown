...
export const AuthProvider = ({ children }) => {
    ...
    const registerUser = async (e) => {
        ...
        let response = await fetch('https://project-pms-kyu.vercel.app/user/register/', {
            method: 'POST',
        ...
        if (response.status === 201) {
            ...
            let loginResponse = await fetch('https://project-pms-kyu.vercel.app/user/token/', {
                method: 'POST',
                headers: { 'Content-Type': 'application/json' },
                body: JSON.stringify({
    ...
    const loginUser = async (e, setError) => {
        e.preventDefault();
        let response = await fetch('https://project-pms-kyu.vercel.app/user/token/', {
            method: 'POST',
            headers: { 'Content-Type': 'application/json' },
            body: JSON.stringify({
                username: e.target.username.value,
